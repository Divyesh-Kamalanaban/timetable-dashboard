        ...
        <div className="flex flex-row items-center justify-center w-screen h-[33vh]">
          {loading ? (
            ...
            year1.map((cls, index) => (
              <div
                key={index}
                className="relative bg-[#3d3d3d] p-8 rounded-xl shadow-lg flex flex-col justify-between h-[14rem] w-[16.6vw] m-2"
              >
                <div>
        ...
        <div className="flex flex-row items-center justify-center w-screen h-[33vh]">
          {loading ? (
            ...
            year2.map((cls, index) => (
              <div
                key={index}
                className="relative bg-[#3d3d3d] p-8 rounded-xl shadow-lg flex flex-col justify-between h-[14rem] w-[33vw] m-2"
              >
                 <div>
                  <h2 className="bg-gradient-to-r from-[#FFDE59] to-[#FF914D] bg-clip-text text-transparent text-2xl font-semibold mb-1">
                    {showperiod(cls)[0]}

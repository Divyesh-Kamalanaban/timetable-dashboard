          ...
          {loading ? (
            ...
            year2.map((cls, index) => (
              ...
              >
                ...
                <div className="absolute bottom-2 right-2 bg-gradient-to-r from-[#7FF899] to-[#22AEF9] bg-clip-text text-transparent text-3xl font-bold">{`2${cls.class}`}</div>
              </div>
            ))
          )}
        </div>
          ...
          {loading ? (
            ...
            year3.map((cls, index) => (
              ...
              >
                ...
                <p className="text-md text-white font-medium">{showperiod(cls)[2]}</p>
                <div className="absolute bottom-2 right-2 bg-gradient-to-r from-[#7FF899] to-[#22AEF9] bg-clip-text text-transparent text-3xl font-bold">{`3${cls.class}`}</div>
              </div>
            ))
          )}
        </div>
